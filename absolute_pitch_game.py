...
#Load the sound files into variables for easy sorting into dictionary
...
#Create dictionary with the interval sounds
...
#Create dictionary with the chord sounds
...
#Create dictionaries for proper names (for easy printing)
...
#Since gui is not supported in colab - options to choose from are printed to the user (inserted into a variable for easy access)
...
def lets_play():
  ...
  sleep(1)
  print("How many steps for the intervals round?")
  while True:
      try:
  ...
  sleep(1)
  print("How many steps for the chords round?")
  while True:
      try:
  ...
  while True:
      try:
          ...
          break
      break
  print("*"*50 + "\nGAME OVER!!! YOUR RESULT IS " + "{:.2f}%".format(calculated_result) + "\n" + "*"*50)
...
def interval_num_of_steps():
    while True:
      interval_num_of_steps = input('How many intervals would you like to practice?\n')
      try:
        ...
        print("The response must be a number, try again")
    return val
...
def chord_num_of_steps():
    while True:
      chord_num_of_steps = input('How many chords would you like to practice?\n')
      try:
...
def absolute_pitch():
  play = 1
  while play == 1:
    print("WELCOME TO THE ABSOLUTE PITCH GAME!!!\n")
    sleep(1)
    ...
    while True:
        try:
            ...
            print("Sorry, I didn't understand that. Please insert 1 or 2")
            continue

        if user_answer not in range(1,3):
            print("Sorry, I didn't understand that. Please insert 1 or 2")
            continue
        else:
            break
    if user_answer == 1:
      ...
      while True:
        try:
            practice_type = int(input())
        except ValueError:
            print("Sorry, I didn't understand that. Please insert 1 or 2")
            continue

        if practice_type not in range(1,3):
            print("Sorry, I didn't understand that. Please insert 1 or 2")
            continue
        else:
            break
    ...
    while True:
        try:
            ...
            print("Sorry, I didn't understand that. Please insert 1 or 2")
            continue
        if another_round not in range(1,3):
            print("Sorry, I didn't understand that. Please insert 1 or 2")
            continue
        else:
            break
    if another_round == 1: play = 1
    else: 
      play = 0
  print("GOODBYE!!!")
